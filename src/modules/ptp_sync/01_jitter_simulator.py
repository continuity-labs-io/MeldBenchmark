...
def main():
    ...
    axs[0].plot(phys_t_b, val_b, label="Sensor B (20kHz with Action Potentials)", color='red', alpha=0.7, linewidth=1.0)
    ...
    axs[1].plot(sw_t_b, val_b, label="Sensor B (Software Clock)", color='red', alpha=0.7, linewidth=1.0)
    axs[1].set_title("Software Clock Reality: Jitter Destroys Causality (time.time() Alignment)", fontsize=14)
