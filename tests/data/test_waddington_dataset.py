...
def test_waddington_shortcut_leakage():
    ...
    assert max_mod0_corr < 0.15, f"Data leakage detected! Modality 0 has correlation {max_mod0_corr} with target."
    ...
    assert max_mod1_corr > 0.5, f"Causal link missing! Modality 1 has max correlation {max_mod1_corr} with target."
